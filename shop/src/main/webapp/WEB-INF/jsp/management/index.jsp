        ...
        <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        <a class="J_menuItem" href="wdcash/index"><i class="fa fa-columns"></i> <span class="nav-label">结算管理</span></a>
                    </li>
                    <li>
                        <a href="#"><i class="fa fa-camera"></i> <span class="nav-label">系统管理</span><span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
        ...
        <!-- 
         ...
         -->
            <div class="row content-tabs">
                ...
                <button class="roll-nav roll-right J_reload" >刷新当前页
                </button>
...
<!--         <div id="small-chat">
    ...
    <script src="<%=basePath %>/assets/management/js/plugins/layer/layer.min.js"></script>
