...
(function (window, document) {
	...
	Croppic.prototype = {
		...
		bindImgUploadControl: function(){
            ...
            //var formHtml = '<form class="' + that.id + '_imgUploadForm" style="visibility: hidden;height:0px">  <input type="file" name="img" id="' + that.id + '_imgUploadField">  </form>';
			var formHtml = '<div class="' + that.id + '_imgUploadForm" style="visibility: hidden;height:0px"><input type="file" name="img" id="' + that.id + '_imgUploadField"></div>';
		...
		crop:function(ansyformdata,callback){
			var that = this;
			...
			if(typeof FormData == 'undefined'){
				...
				for (var key in ansyformdata) {
					if( ansyformdata.hasOwnProperty(key) ) {
							formData.append( key , ansyformdata[key] );
					}
				}
