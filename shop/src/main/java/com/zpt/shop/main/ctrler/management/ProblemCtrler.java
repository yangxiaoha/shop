...
public class ProblemCtrler {
	...
	public String index(){
		return "/management/problem/index";	
	}
	
	@ResponseBody
	@RequestMapping(value = "selProblem",method = RequestMethod.POST)
	public String selproblem(){
		System sys = systemService.selProblem();
	...
	public Msg update(String sysvalue){
		Msg msg = new Msg();
		try {
			systemService.updateProblem(sysvalue);
