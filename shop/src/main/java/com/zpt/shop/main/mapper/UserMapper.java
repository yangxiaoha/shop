...
public interface UserMapper {
	 ...
	 * */
	public void addUser(@Param("openId")String fromUserName, @Param("name")String userName, @Param("regtime")String createTime, @Param("pid")Integer pid, @Param("money")String money);
	 ...
	 * @param String createTime 用户openId
	 * */
	public void updateUser(@Param("openId")String fromUserName, @Param("name")String userName, @Param("regtime")String createTime, @Param("pid")Integer pid);
